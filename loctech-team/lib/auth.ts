...
export const authConfig: NextAuthOptions = {
  ...
  callbacks: {
        ...
        try {
          ...
          const data = () => {
            const formatted: User = {
              ...
              title: userModel.title ?? undefined,
              phone: userModel.phone ?? "",
              bankDetails: userModel.bankDetails
                ? userModel.bankDetails
                : undefined,
    ...
    async session({ session, token }) {
      await connectToDatabase();
      const userModel = await UserModel.findById((token.user as User)?.id);
      ...
      const user: User = {
        ...
        title: userModel.title ?? undefined,
        phone: userModel.phone ?? "",
        bankDetails: userModel.bankDetails ? userModel.bankDetails : undefined,
        createdAt: userModel.createdAt,
      };
      return {
        ...session,
