...
function EnhancedAdminOverview({ stats }: { stats: DashboardStats }) {
  return (
        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            <Button variant="outline" size="sm" className="w-full" asChild>
              <Link href={userLinks.classes}>
                <GraduationCap className="mr-2 h-4 w-4" />
                Manage Classes
              </Link>
            </Button>
            <Button variant="outline" size="sm" className="w-full" asChild>
              <Link href={userLinks.attendance.monitoring}>
                <AlertTriangle className="mr-2 h-4 w-4" />
                Monitor Attendance
              </Link>
            </Button>
            <Button variant="outline" size="sm" className="w-full" asChild>
              <Link href={userLinks.cbt.exams}>
                <ClipboardList className="mr-2 h-4 w-4" />
                Manage Exams
              </Link>
            </Button>
            <Button variant="outline" size="sm" className="w-full" asChild>
              <Link href={userLinks.cbt.questions}>
